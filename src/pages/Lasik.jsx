...
import lasikMasukSound from '../assets/voice/lasik_masuk.mp3';
...
const Lasik = () => {
    ...
    useEffect(() => {
        const audio = new Audio(lasikMasukSound);
        audio.volume = 1.0;
    ...
    const handleDownloadPDF = async () => {
            ...
            <div class="page-container">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <strong>Booking Layanan LASIK</strong>
        ...
        try {
            ...
            doc.save(`Invoice-LASIK-${selectedDetail.no_invoice}.pdf`);
        } catch (err) {
